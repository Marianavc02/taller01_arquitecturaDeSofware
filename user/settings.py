"""
Django settings for safedesk project.
...
SECRET_KEY = 'django-insecure-j)ppf!aq6lv22vve!!ai^*o_%yj+$lp!oi(2(8hl=ehk$f@!lv'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '3.84.92.230']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'safedesk/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
